...
export default function SchedulesPage(props) {
    ...
    const createScheduleHandler = (startDay) => {
    ...
    const editScheduleHandler = (startDay, scheduleId) => {
        const jwt = props.userInfo.token;
    ...
    const deleteScheduleHandler = (startDay) => {
        const userId = props.userInfo._id;
        const jwt = props.userInfo.token;
    ...
    const sortedSchedules = schedules.sort((a, b) => Number(a.startDay) > Number(b.startDay) ? 1 : -1);
